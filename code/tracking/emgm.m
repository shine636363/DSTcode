...
nk = sum(R,1);  % the number of clustered points in each label
w = nk/n;       % the weight depends on the number of clustered points
mu = bsxfun(@times, X*R, 1./nk);   % compute the mean value
